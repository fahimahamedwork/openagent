...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open OpenAgent console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About OpenAgent",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit OpenAgent",
		Exiting:            "Exiting OpenAgent...",
		DocUrl:             "https://docs.openagent.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 OpenAgent 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 OpenAgent",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 OpenAgent",
		Exiting:            "正在退出 OpenAgent...",
		DocUrl:             "https://docs.openagent.io/zh-Hans/docs/",
	},
}
