...
import (
	...
	tuicfg "github.com/fahimahamedwork/openagent/cmd/openagent-launcher-tui/config"
	"github.com/fahimahamedwork/openagent/cmd/openagent-launcher-tui/ui"
)
...
func main() {
	...
	if _, err := os.Stat(configDir); os.IsNotExist(err) {
		cmd := exec.Command("openagent", "onboard")
		cmd.Stdin = os.Stdin
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "openagent-launcher-tui: %v\n", err)
		os.Exit(1)
	}
