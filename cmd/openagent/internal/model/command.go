...
Examples:
  openagent model                    # Show current default model
  openagent model gpt-5.2           # Set gpt-5.2 as default
  openagent model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  openagent model local-model       # Set local VLLM server as default
