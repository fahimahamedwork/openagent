...
import (
	...
	"github.com/fahimahamedwork/openagent/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return gateway.Run(debug, internal.GetOpenAgentHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
