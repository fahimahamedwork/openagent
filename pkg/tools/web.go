...
const (
	...
	userAgentHonest = "openagent/%s (+https://github.com/fahimahamedwork/openagent; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(
	...
	// Format results in standard OpenAgent format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies openagent, which some
