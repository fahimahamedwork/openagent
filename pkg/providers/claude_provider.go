...
import (
	...
	anthropicprovider "github.com/fahimahamedwork/openagent/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: openagent auth login --provider anthropic")
		}
