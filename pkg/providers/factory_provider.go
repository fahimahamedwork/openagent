...
import (
	...
	anthropicmessages "github.com/fahimahamedwork/openagent/pkg/providers/anthropic_messages"
	"github.com/fahimahamedwork/openagent/pkg/providers/azure"
	"github.com/fahimahamedwork/openagent/pkg/providers/bedrock"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: openagent auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: openagent auth login --provider openai")
	}
...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	if userAgent == "" {
		userAgent = fmt.Sprintf("OpenAgent/%s", config.Version)
	}
